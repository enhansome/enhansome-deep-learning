# Awesome Deep Learning with stars
...
5. [neuraltalk](https://github.com/karpathy/neuraltalk) ⭐ 5,499 | 🐛 30 | 🌐 Python | 📅 2020-12-22 by Andrej Karpathy : numpy-based RNN/LSTM implementation
...
*You can also find the most cited deep learning papers from [here](https://github.com/terryum/awesome-deep-learning-papers) ⭐ 26,175 | 🐛 37 | 🌐 TeX | 📅 2024-01-18*
...
1. [TensorFlow Python Notebooks](https://github.com/aymericdamien/TensorFlow-Examples) ⭐ 43,738 | 🐛 228 | 🌐 Jupyter Notebook | 📅 2024-07-26
2. [Pytorch Tutorial by Yunjey Choi](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,450 | 🐛 90 | 🌐 Python | 📅 2023-08-15
...
6. [Classification on raw time series in TensorFlow with a LSTM RNN](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition) ⭐ 3,488 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2022-11-06
7. [The Best Machine Learning Tutorials On The Web](https://github.com/josephmisiti/machine-learning-module) ⭐ 477 | 🐛 0 | 🌐 Objective-C | 📅 2011-04-28
...
10. [Hardware for AI: Understanding computer hardware & build your own computer](https://github.com/MelAbgrall/HardwareforAI) ⭐ 13 | 🐛 0 | 📅 2022-03-10
11. [UFLDL Tutorial 1](http://deeplearning.stanford.edu/wiki/index.php/UFLDL_Tutorial)
12. [UFLDL Tutorial 2](http://ufldl.stanford.edu/tutorial/supervised/LinearRegression/)
13. [Deep Learning for NLP (without Magic)](http://www.socher.org/index.php/DeepLearningTutorial/DeepLearningTutorial)
14. [A Deep Learning Tutorial: From Perceptrons to Deep Networks](http://www.toptal.com/machine-learning/an-introduction-to-deep-learning-from-perceptrons-to-deep-networks)
15. [Deep Learning from the Bottom up](http://www.metacademy.org/roadmaps/rgrosse/deep_learning)
16. [Theano Tutorial](http://deeplearning.net/tutorial/deeplearning.pdf)
17. [Neural Networks for Matlab](http://uk.mathworks.com/help/pdf_doc/nnet/nnet_ug.pdf)
18. [Using convolutional neural nets to detect facial keypoints tutorial](http://danielnouri.org/notes/2014/12/17/using-convolutional-neural-nets-to-detect-facial-keypoints-tutorial/)
19. [VGG Convolutional Neural Networks Practical](http://www.robots.ox.ac.uk/~vgg/practicals/cnn/index.html)
20. [Using convolutional neural nets to detect facial keypoints tutorial](http://danielnouri.org/notes/2014/12/17/using-convolutional-neural-nets-to-detect-facial-keypoints-tutorial/)
21. [Deep Learning with Python](https://www.manning.com/books/deep-learning-with-python)
22. [Grokking Deep Learning](https://www.manning.com/books/grokking-deep-learning)
23. [Deep Learning for Search](https://www.manning.com/books/deep-learning-for-search)
24. [Keras Tutorial: Content Based Image Retrieval Using a Convolutional Denoising Autoencoder](https://medium.com/sicara/keras-tutorial-content-based-image-retrieval-convolutional-denoising-autoencoder-dc91450cc511)
25. [Understanding deep Convolutional Neural Networks with a practical use-case in Tensorflow and Keras](https://ahmedbesbes.com/understanding-deep-convolutional-neural-networks-with-a-practical-use-case-in-tensorflow-and-keras.html)
26. [Overview and benchmark of traditional and deep learning models in text classification](https://ahmedbesbes.com/overview-and-benchmark-of-traditional-and-deep-learning-models-in-text-classification.html)
...
1. [Fashion-MNIST](https://github.com/zalandoresearch/fashion-mnist) ⭐ 12,809 | 🐛 34 | 🌐 Python | 📅 2022-06-13 - MNIST like fashion product dataset consisting of a training set of 60,000 examples and a test set of 10,000 examples. Each example is a 28x28 grayscale image, associated with a label from 10 classes.
2. [Open Images dataset](https://github.com/openimages/dataset) ⭐ 4,376 | 🐛 37 | 🌐 Python | 📅 2021-07-01 - Open Images is a dataset of \~9 million URLs to images that have been annotated with labels spanning over 6000 categories.
...
4. [LLVIP](https://github.com/bupt-ai-cz/LLVIP) ⭐ 839 | 🐛 32 | 🌐 Jupyter Notebook | 📅 2025-08-09 - 15488 visible-infrared paired images (30976 images) for low-light vision research, [Project\_Page](https://bupt-ai-cz.github.io/LLVIP/)
...
30. [CMU CIL's Stereo Data with Ground Truth](cil-ster.html) - 3 sets of 11 images, including color tiff images with spectroradiometry (Formats: gif, tiff)
...
62. [JISCT Stereo Evaluation](ftp://ftp.vislist.com/IMAGERY/JISCT/) - 44 image pairs. These data have been used in an evaluation of stereo analysis, as described in the April 1993 ARPA Image Understanding Workshop paper \`\`The JISCT Stereo Evaluation'' by R.C.Bolles, H.H.Baker, and M.J.Hannah, 263--274 (Formats: SSI)
...
64. [MIT face images and more](ftp://whitechapel.media.mit.edu/pub/images) - hundreds of images (Formats: homebrew)
...
67. <ftp://ftp.cps.msu.edu/pub/prip> - many images (Formats: unknown)
...
71. [NIST Fingerprint and handwriting](ftp://sequoyah.ncsl.nist.gov/pub/databases/data) - datasets - thousands of images (Formats: unknown)
72. [NIST Fingerprint data](ftp://ftp.cs.columbia.edu/jpeg/other/uuencoded) - compressed multipart uuencoded tar file
...
82. <ftp://ftp.limsi.fr/pub/quenot/opflow/testdata/piv/> - Real and synthetic image sequences used for testing a Particle Image Velocimetry application. These images may be used for the test of optical flow and image matching algorithms. (Formats: pgm (raw))
...
101. [U Bern Face images](ftp://ftp.iam.unibe.ch/pub/Images/FaceImages) - hundreds of images (Formats: Sun rasterfile)
102. [U Michigan textures](ftp://freebie.engin.umich.edu/pub/misc/textures) (Formats: compressed raw)
...
106. [UNC's 3D image database](ftp://sunsite.unc.edu/pub/academic/computer-science/virtual-reality/3d) - many images (Formats: GIF)
...
112. [Usenix face database](ftp://ftp.uu.net/published/usenix/faces) - Thousands of face images from many different sites (circa 994)
...
115. [Vision-list Imagery Archive](ftp://ftp.vislist.com/IMAGERY/) - Many images, many formats
...
1. [Tensorflow - Open source software library for numerical computation using data flow graphs](https://github.com/tensorflow/tensorflow) ⭐ 196,990 | 🐛 2,826 | 🌐 C++ | 📅 2026-08-13
2. [PyTorch - Tensors and Dynamic neural networks in Python with strong GPU acceleration](https://github.com/pytorch/pytorch) ⭐ 102,352 | 🐛 17,170 | 🌐 Python | 📅 2026-08-13
3. [SyntaxNet - Google's syntactic parser - A TensorFlow dependency library](https://github.com/tensorflow/models/tree/master/syntaxnet) ⭐ 77,660 | 🐛 1,275 | 🌐 Python | 📅 2026-08-12
4. [Colossal-AI - An Integrated Large-scale Model Training System with Efficient Parallelization Techniques](https://github.com/hpcaitech/ColossalAI) ⭐ 41,435 | 🐛 504 | 🌐 Python | 📅 2026-08-10
5. [Paddle - PArallel Distributed Deep LEarning by Baidu](https://github.com/baidu/paddle) ⭐ 24,048 | 🐛 1,518 | 🌐 C++ | 📅 2026-08-13
...
9. [char-rnn](https://github.com/karpathy/char-rnn) ⭐ 12,084 | 🐛 111 | 🌐 Lua | 📅 2023-10-24
10. [convetjs](https://github.com/karpathy/convnetjs) ⭐ 11,193 | 🐛 76 | 🌐 JavaScript | 📅 2023-01-07
11. [Sonnet - a library for constructing neural networks by Google's DeepMind](https://github.com/deepmind/sonnet) ⭐ 9,943 | 🐛 43 | 🌐 Python | 📅 2026-07-07
...
16. [Flax - a neural network ecosystem for JAX that is designed for flexibility](https://github.com/google/flax) ⭐ 7,296 | 🐛 501 | 🌐 Jupyter Notebook | 📅 2026-08-12
17. [Feast - A Feature Store for ML for GCP by Gojek/Google](https://github.com/gojek/feast) ⭐ 7,207 | 🐛 409 | 🌐 Python | 📅 2026-08-11
18. [PyTorch Geometric Temporal - Representation learning on dynamic graphs](https://github.com/gojek/feast) ⭐ 7,207 | 🐛 409 | 🌐 Python | 📅 2026-08-11
...
22. [DeepLearnToolbox](https://github.com/rasmusbergpalm/DeepLearnToolbox) ⭐ 3,867 | 🐛 83 | 🌐 Matlab | 📅 2018-10-13
23. [Neon - Python based Deep Learning Framework](https://github.com/NervanaSystems/neon) ⚠️ Archived
24. [Lasagne - a lightweight library to build and train neural networks in Theano](https://github.com/Lasagne/Lasagne) ⭐ 3,859 | 🐛 139 | 🌐 Python | 📅 2022-03-26
25. [lightly - A computer vision framework for self-supervised learning](https://github.com/lightly-ai/lightly) ⭐ 3,794 | 🐛 100 | 🌐 Python | 📅 2026-08-12
26. [Catalyst: High-level utils for PyTorch DL & RL research. It was developed with a focus on reproducibility, fast experimentation and code/ideas reusing](https://github.com/catalyst-team/catalyst) ⭐ 3,380 | 🐛 6 | 🌐 Python | 📅 2026-07-08
27. [TensorForce - A TensorFlow library for applied reinforcement learning](https://github.com/reinforceio/tensorforce) ⭐ 3,306 | 🐛 44 | 🌐 Python | 📅 2026-07-14
...
30. [Karate Club - An unsupervised machine learning library for graph structured data](https://github.com/benedekrozemberczki/karateclub) ⭐ 2,285 | 🐛 12 | 🌐 Python | 📅 2024-07-17
31. [garage - A toolkit for reproducible reinforcement learning research](https://github.com/rlworkgroup/garage) ⭐ 2,123 | 🐛 234 | 🌐 Python | 📅 2023-05-04
32. [Knet.jl](https://github.com/denizyuret/Knet.jl) ⭐ 1,433 | 🐛 153 | 🌐 Jupyter Notebook | 📅 2024-11-15
...
35. [Brainstorm - Fast, flexible and fun neural networks.](https://github.com/IDSIA/brainstorm) ⭐ 1,320 | 🐛 27 | 🌐 Python | 📅 2022-09-13
36. [Hopsworks - A Feature Store for ML and Data-Intensive AI](https://github.com/logicalclocks/hopsworks) ⭐ 1,302 | 🐛 16 | 🌐 Java | 📅 2025-02-10
...
39. [hebel](https://github.com/hannes-brt/hebel) ⭐ 1,169 | 🐛 6 | 🌐 Python | 📅 2020-12-29
40. [Torchnet - Torch based Deep Learning Library](https://github.com/torchnet/torchnet) ⚠️ Archived
41. [nolearn - wrappers and abstractions around existing neural network libraries, most notably Lasagne](https://github.com/dnouri/nolearn) ⭐ 952 | 🐛 42 | 🌐 Python | 📅 2023-07-06
...
45. [Detecto - Train and run object detection models with 5-10 lines of code](https://github.com/alankbi/detecto) ⭐ 627 | 🐛 48 | 🌐 Python | 📅 2024-07-25
46. [Neuraxle - A general-purpose ML pipelining framework](https://github.com/Neuraxio/Neuraxle) ⭐ 614 | 🐛 2 | 🌐 Python | 📅 2026-02-20
47. [Marvin - A Minimalist GPU-only N-Dimensional ConvNets Framework](https://github.com/PrincetonVision/marvin) ⭐ 428 | 🐛 17 | 🌐 C++ | 📅 2018-03-21
48. [Maze](https://github.com/enlite-ai/maze) ⭐ 292 | 🐛 2 | 🌐 Python | 📅 2026-06-01 - Application-oriented deep reinforcement learning framework addressing real-world decision problems.
49. [OpenDL](https://github.com/guoding83128/OpenDL) ⭐ 219 | 🐛 2 | 🌐 Java | 📅 2025-05-03
50. [Synapses - A lightweight library for neural networks that runs anywhere](https://github.com/mrdimosthenis/Synapses) ⭐ 73 | 🐛 0 | 📅 2021-09-23
51. [InsNet - A neural network library for building instance-dependent NLP models with padding-free dynamic batching](https://github.com/chncwang/InsNet) ⭐ 68 | 🐛 0 | 🌐 C++ | 📅 2021-11-20
52. [QuickVision](https://github.com/Quick-AI/quickvision) ⭐ 52 | 🐛 20 | 🌐 Python | 📅 2023-07-06
53. [Caffe](http://caffe.berkeleyvision.org/)
54. [Torch7](http://torch.ch/)
55. [Theano](http://deeplearning.net/software/theano/)
56. [cuda-convnet](https://code.google.com/p/cuda-convnet2/)
57. [Ccv](http://libccv.org/doc/doc-convnet/)
58. [NuPIC](http://numenta.org/nupic.html)
59. [DeepLearning4J](http://deeplearning4j.org/)
60. [cuDNN](https://developer.nvidia.com/cuDNN)
61. [MGL](http://melisgl.github.io/mgl-pax-world/mgl-manual.html)
62. [Keras - Theano based Deep Learning Library](http://keras.io)
63. [Chainer - A flexible framework of neural networks for deep learning](http://chainer.org/)
64. [RNNLM Toolkit](http://rnnlm.org/)
65. [RNNLIB - A recurrent neural network library](http://sourceforge.net/p/rnnl/wiki/Home/)
66. [Apache SINGA - A General Distributed Deep Learning Platform](http://singa.incubator.apache.org/)
67. [mlpack - A scalable Machine Learning library](http://mlpack.org/)
68. [NeuPy - Theano based Python library for ANN and Deep Learning](http://neupy.com)
69. [TVM - End to End Deep Learning Compiler Stack for CPUs, GPUs and specialized accelerators](https://tvm.ai/)
70. [Coach - Reinforcement Learning Coach by Intel® AI Lab](https://github.com/NervanaSystems/coach)
71. [haystack: an open-source neural search framework](https://haystack.deepset.ai/docs/intromd)

### Tools

1. [Netron](https://github.com/lutzroeder/netron) ⭐ 33,342 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-12 - Visualizer for deep learning and machine learning models
2. [hub](https://github.com/activeloopai/Hub) ⭐ 9,226 | 🐛 65 | 🌐 C++ | 📅 2026-05-21 - Fastest unstructured dataset management for TensorFlow/PyTorch by activeloop.ai. Stream & version-control data. Converts large data into single     numpy-like array on the cloud, accessible on any machine.
3. [Nebullvm](https://github.com/nebuly-ai/nebullvm) ⭐ 8,330 | 🐛 110 | 🌐 Python | 📅 2024-07-22 - Easy-to-use library to boost deep learning inference leveraging multiple deep learning compilers.
4. [TensorBoard](https://github.com/tensorflow/tensorboard) ⭐ 7,203 | 🐛 750 | 🌐 TypeScript | 📅 2026-08-07 - TensorFlow's Visualization Toolkit
5. [ML Workspace](https://github.com/ml-tooling/ml-workspace) ⭐ 3,543 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2024-07-26 - All-in-one web-based IDE for machine learning and data science.
6. [TensorWatch](https://github.com/microsoft/tensorwatch) ⭐ 3,470 | 🐛 54 | 🌐 Jupyter Notebook | 📅 2026-03-30 - Debugging and visualization for deep learning
7. [Determined](https://github.com/determined-ai/determined) ⭐ 3,233 | 🐛 108 | 🌐 Go | 📅 2025-03-20 - Deep learning training platform with integrated support for distributed training, hyperparameter tuning, smart GPU scheduling, experiment tracking, and a model registry.
...
11. [Neptune](https://neptune.ai/) - Lightweight tool for experiment tracking and results visualization.
12. [CatalyzeX](https://chrome.google.com/webstore/detail/code-finder-for-research/aikkeehnlfpamidigaffhfmgbkdeheil) - Browser extension ([Chrome](https://chrome.google.com/webstore/detail/code-finder-for-research/aikkeehnlfpamidigaffhfmgbkdeheil) and [Firefox](https://addons.mozilla.org/en-US/firefox/addon/code-finder-catalyzex/)) that automatically finds and links to code implementations for ML papers anywhere online: Google, Twitter, Arxiv, Scholar, etc.
13. [DAGsHub](https://dagshub.com/) - Community platform for Open Source ML – Manage experiments, data & models and create collaborative ML projects easily.
...
1. [AI Expert Roadmap](https://github.com/AMAI-GmbH/AI-Expert-Roadmap) ⭐ 31,203 | 🐛 19 | 🌐 JavaScript | 📅 2025-09-12 - Roadmap to becoming an Artificial Intelligence Expert
2. [Machine Learning for Software Engineers](https://github.com/ZuzooVn/machine-learning-for-software-engineers) ⭐ 28,857 | 🐛 32 | 📅 2024-06-11
3. [Microsoft Recommenders](https://github.com/Microsoft/Recommenders) ⭐ 21,851 | 🐛 176 | 🌐 Python | 📅 2026-08-10 contains examples, utilities and best practices for building recommendation systems. Implementations of several state-of-the-art algorithms are provided for self-study and customization in your own applications.
4. [Face recognition with Google's FaceNet deep neural network.](https://github.com/cmusatyalab/openface) ⭐ 15,433 | 🐛 1 | 🌐 Lua | 📅 2026-07-18
5. [Google deepdream - Neural Network art](https://github.com/google/deepdream) ⚠️ Archived
6. [Torch7 Cheat sheet](https://github.com/torch/torch7/wiki/Cheatsheet) ⭐ 9,138 | 🐛 298 | 🌐 C | 📅 2025-03-31
7. [Awesome Graph Embedding](https://github.com/benedekrozemberczki/awesome-graph-embedding) ⭐ 4,799 | 🐛 0 | 🌐 Python | 📅 2023-03-18 - Curated list of articles related to deep learning scientific research on graph structured data at the graph level.
8. [Awesome Deep Learning Music](https://github.com/ybayle/awesome-deep-learning-music) ⭐ 2,979 | 🐛 7 | 🌐 TeX | 📅 2023-12-15 - Curated list of articles related to deep learning scientific research applied to music
...
10. [Awesome Network Embedding](https://github.com/chihming/awesome-network-embedding) ⭐ 2,626 | 🐛 4 | 📅 2020-12-08 - Curated list of articles related to deep learning scientific research on graph structured data at the node level.
11. [A recurrent neural network designed to generate classical music.](https://github.com/hexahedria/biaxial-rnn-music-composition) ⭐ 1,926 | 🐛 10 | 🌐 Python | 📅 2023-12-12
12. [The original code from the DeepMind article + tweaks](https://github.com/kuz/DeepMind-Atari-Deep-Q-Learner) ⭐ 1,829 | 🐛 23 | 🌐 Lua | 📅 2018-01-23
13. [Memory Networks Implementations - Facebook](https://github.com/facebook/MemNN) ⚠️ Archived
14. [A chess AI that learns to play chess using deep learning.](https://github.com/erikbern/deep-pink) ⭐ 832 | 🐛 9 | 🌐 Python | 📅 2017-02-20
15. [Reproducing the results of "Playing Atari with Deep Reinforcement Learning" by DeepMind](https://github.com/kristjankorjus/Replicating-DeepMind) ⭐ 666 | 🐛 11 | 🌐 C++ | 📅 2015-02-09
16. [Wiki2Vec. Getting Word2vec vectors for entities and word from Wikipedia Dumps](https://github.com/idio/wiki2vec) ⚠️ Archived
17. [TorontoDeepLEarning convnet](https://github.com/TorontoDeepLearning/convnet) ⭐ 504 | 🐛 24 | 🌐 Cuda | 📅 2020-10-01
18. [Dockerface](https://github.com/natanielruiz/dockerface) ⭐ 191 | 🐛 4 | 🌐 Dockerfile | 📅 2020-06-20 - Easy to install and use deep learning Faster R-CNN face detection for images and video in a docker container.
19. [gfx.js](https://github.com/clementfarabet/gfx.js) ⭐ 124 | 🐛 24 | 🌐 JavaScript | 📅 2017-10-05
20. [Awesome Drug Interactions, Synergy, and Polypharmacy Prediction](https://github.com/AstraZeneca/awesome-polipharmacy-side-effect-prediction/) ⭐ 101 | 🐛 0 | 📅 2022-08-07
21. [Ladder Network](https://github.com/divamgupta/ladder_network_keras) ⭐ 99 | 🐛 6 | 🌐 Python | 📅 2021-04-30 - Keras Implementation of Ladder Network for Semi-Supervised Learning
22. [Basic digit recognition neural network](https://github.com/joeledenberg/DigitRecognition) ⭐ 95 | 🐛 2 | 🌐 Python | 📅 2013-01-26
23. [Caffe DockerFile](https://github.com/tleyden/docker/tree/master/caffe) ⭐ 82 | 🐛 4 | 🌐 Dockerfile | 📅 2021-10-08
24. [Caffe Webinar](http://on-demand-gtc.gputechconf.com/gtcnew/on-demand-gtc.php?searchByKeyword=shelhamer\&searchItems=\&sessionTopic=\&sessionEvent=4\&sessionYear=2014\&sessionFormat=\&submit=\&select=+)
25. [100 Best Github Resources in Github for DL](http://meta-guide.com/software-meta-guide/100-best-github-deep-learning/)
26. [Word2Vec](https://code.google.com/p/word2vec/)
27. [Misc from MIT's 'Advanced Natural Language Processing' course](http://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-864-advanced-natural-language-processing-fall-2005/)
28. [Misc from MIT's 'Machine Learning' course](http://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-867-machine-learning-fall-2006/lecture-notes/)
29. [Misc from MIT's 'Networks for Learning: Regression and Classification' course](http://ocw.mit.edu/courses/brain-and-cognitive-sciences/9-520-a-networks-for-learning-regression-and-classification-spring-2001/)
30. [Misc from MIT's 'Neural Coding and Perception of Sound' course](http://ocw.mit.edu/courses/health-sciences-and-technology/hst-723j-neural-coding-and-perception-of-sound-spring-2005/index.htm)
31. [Implementing a Distributed Deep Learning Network over Spark](http://www.datasciencecentral.com/profiles/blogs/implementing-a-distributed-deep-learning-network-over-spark)
32. [An efficient, batched LSTM.](https://gist.github.com/karpathy/587454dc0146a6ae21fc)
33. [Emotion Recognition API Demo - Microsoft](https://www.projectoxford.ai/demo/emotion#detection)
34. [YOLO: Real-Time Object Detection](http://pjreddie.com/darknet/yolo/#webcam)
35. [YOLO: Practical Implementation using Python](https://www.analyticsvidhya.com/blog/2018/12/practical-guide-object-detection-yolo-framewor-python/)
36. [AlphaGo - A replication of DeepMind's 2016 Nature publication, "Mastering the game of Go with deep neural networks and tree search"](https://github.com/Rochester-NRT/AlphaGo)
37. [Machine Learning is Fun!](https://medium.com/@ageitgey/machine-learning-is-fun-80ea3ec3c471#.oa4rzez3g)
38. [Siraj Raval's Deep Learning tutorials](https://www.youtube.com/channel/UCWN3xxRkmTPmbKwht9FuE5A)
39. [The Unreasonable Effectiveness of Recurrent Neural Networks](http://karpathy.github.io/2015/05/21/rnn-effectiveness/) - Andrej Karpathy blog post about using RNN for generating text.
...
Have anything in mind that you think is awesome and would fit in this list? Feel free to send a [pull request](https://github.com/ashara12/awesome-deeplearning/pulls) ⭐ 28,743 | 🐛 84 | 📅 2025-05-26.
